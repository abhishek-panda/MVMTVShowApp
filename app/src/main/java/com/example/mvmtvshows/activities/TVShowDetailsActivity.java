...
import com.example.mvmtvshows.adapters.EpisodesAdapter;
import com.example.mvmtvshows.adapters.ImageSliderAdapter;
import com.example.mvmtvshows.databinding.ActivityTvshowDetailsBinding;
import com.example.mvmtvshows.databinding.LayoutEpisodesBottomSheetBinding;
import com.example.mvmtvshows.models.TVShow;
import com.example.mvmtvshows.utilities.TempDataHolder;
import com.example.mvmtvshows.viewmodels.TVShowDetailsViewModel;
...
public class TVShowDetailsActivity extends AppCompatActivity {
                ...
                activityTvshowDetailsBinding.buttonEpisodes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (episodesBottomSheetDialog == null) {
                            ...
                            layoutEpisodesBottomSheetBinding.iamgeClose.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
    ...
    private void loadImageSlider(String[] sliderImages) {
        activityTvshowDetailsBinding.silderViewPager.setOffscreenPageLimit(1);
        activityTvshowDetailsBinding.silderViewPager.setAdapter(new ImageSliderAdapter(sliderImages));
        activityTvshowDetailsBinding.silderViewPager.setVisibility(View.VISIBLE);
        activityTvshowDetailsBinding.viewFadingEdge.setVisibility(View.VISIBLE);
        setupSliderIndicators(sliderImages.length);
        activityTvshowDetailsBinding.silderViewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            @Override
